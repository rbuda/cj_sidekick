...
function openKibana(arr) {
  if (arr != null && arr.enterpriseID != (null || 0) > 0 && arr.orderID.length != (0)) {
    window.open("http://kibana.int.cj.com/#/dashboard/CIE_Dashboard?_g=(refreshInterval:(display:Off,pause:!f,section:0,value:0),time:(from:now-"+arr.time+",mode:quick,to:now))&_a=(filters:!(),panels:!((col:1,columns:!(coreview.event_time_utc,coreview.last_click_time,coreview.query.oid,coreview.request_url,coreview.query_string,coreview.referring_url,coreview.client_ip_address),id:dkcieSrch,row:13,size_x:12,size_y:4,sort:!(coreview.event_time_utc,desc),type:search),(col:7,id:VIEWS__dkcie,row:1,size_x:6,size_y:4,type:visualization),(col:7,id:VIEWS_IN_AP__dkcie,row:5,size_x:6,size_y:3,type:visualization),(col:1,id:HITS__dkcie,row:1,size_x:2,size_y:2,type:visualization),(col:1,id:DK4_01-apbad_error_code,row:3,size_x:2,size_y:2,type:visualization),(col:7,id:Device_is_Mobile_Desktop_Other___dkc,row:8,size_x:6,size_y:3,type:visualization),(col:1,id:Top-10-Amount-Values,row:5,size_x:2,size_y:4,type:visualization),(col:5,id:Top-10-Item1-Values,row:5,size_x:2,size_y:4,type:visualization),(col:3,id:Top-10-OID-Values,row:5,size_x:2,size_y:4,type:visualization),(col:3,id:Top-10-Action-Values,row:9,size_x:2,size_y:4,type:visualization),(col:1,id:Top-10-Coupon-Values,row:9,size_x:2,size_y:4,type:visualization),(col:5,id:'Top-10-Enterprise-ID!'s',row:1,size_x:2,size_y:4,type:visualization),(col:5,id:Top-10-AMT1-Values,row:9,size_x:2,size_y:4,type:visualization),(col:7,id:'Top-10-Referring-URL!'s',row:11,size_x:2,size_y:2,type:visualization),(col:11,id:Top-10-Discount-Values,row:11,size_x:2,size_y:2,type:visualization),(col:3,id:Top-10-CJEVENT-Values,row:1,size_x:2,size_y:4,type:visualization),(col:9,id:Top-10-Channels,row:11,size_x:2,size_y:2,type:visualization)),query:(query_string:(analyze_wildcard:!t,query:'coreview.query.oid:%20%22"+arr.orderID+"%22%20AND%20coreview.enterprise_id:%20%22"+arr.enterpriseID+"%22')),title:CIE_Dashboard)");
